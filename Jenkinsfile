podTemplate(
  label: 'skaffold',
  containers: [
    containerTemplate(name: 'skaffold-insider', image: 'takashi-tanaka/skaffold-insider:v1.0.0', ttyEnabled: true, command: 'cat')
  ],
  volumes: [
  ...
  node('skaffold') {
    withCredentials([
      ...
      stage('Test skaffold') {
        git 'https://github.com/takashi-tanaka/cowweb.git'
        container('skaffold-insider') {
          sh """
